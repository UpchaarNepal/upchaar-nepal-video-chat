...
window.addEventListener( 'load', () => {
    ...
    console.log("🚀 ~ file: rtc.js:9 ~ window.addEventListener ~ room:", room)
    ...
    if ( !room ) {
        ...
        let socket = io( 'http://localhost:8080/stream' );
        ...
        socket.on( 'connection', () => {
            ...
            socket.on( 'ice_candidates', async ( data ) => {
        ...
        function init( createOffer, partnerName ) {
            ...
            pc[partnerName].onicecandidate = ( { candidate } ) => {
                socket.emit( 'ice_candidates', { candidate: candidate, to: partnerName, sender: socketId } );
            };
